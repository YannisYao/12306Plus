...
#初始化使用代理设置
proxy_support = urllib.request.ProxyHandler({'http':'http://hexin:hx300033@192.168.0.1:88/'})
...
class DamatuApi():
	...
	def decode(self,filePath,type):
		...
		if jres['ret'] == 0:
			...
			return(jres['ret'],jres['result'],jres['id'])
		else:
			return (jres['ret'],)
...
#dmt=DamatuApi("yannisyao","yaoliang123")
#2.调用方法：
#print(dmt.getBalance()) #查询余额
#print(dmt.decode('0349.bmp',310)) #上传打码
